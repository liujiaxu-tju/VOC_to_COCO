...
def addCatItem(name):
    ...
    category_item_id += 1
    # category_item_id = category_set_id[name]
...
def parseXmlFiles(xml_path, files):
    for f in files:
    ...
    #         continue
        ...
        xml_file = os.path.join(xml_path, f.replace('\n', '.xml'))
        print(xml_file)

        tree = ET.parse(xml_file)
        root = tree.getroot() #ץ¸ùԪË

        if root.tag != 'annotation': #¸ù±ê
        ...
        for elem in root:
            ...
            # add img item only after parse <size> tag
                ...
                if file_name not in image_set:
                    current_image_id = addImgItem(file_name, size)#ͼƬÐϢ
...
if __name__ == '__main__':
    ...
    # TODO: you need to change these 3 variables according to your datasetcd
    ...
    splits = ['train', 'val', 'trainval', 'test-dev', 'test-challenge']
    ...
    for i in splits:
        ...
        json_file = './json/voc_2012_{}.json'.format(i)
        xml_file_index = './VOCdevkit2012/VOC2012/ImageSets/Main/{}.txt'.format(i)
        # print category_set
